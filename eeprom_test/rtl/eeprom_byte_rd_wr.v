...
(
  ...
  // output  wire            LED1        ,   //输出数据存储器时钟
  // output  wire            LED2        ,   //移位寄存器的时钟输入
  //  output  wire           LED3        ,   //串行数据输入
  // output  wire            LED4              //使能信号
);
...
i2c_ctrl
#(
    .DEVICE_ADDR    (7'b1010_000     ), //i2c设备器件地址
    .SYS_CLK_FREQ   (26'd40_000_000  ), //i2c_ctrl模块系统时钟频率
